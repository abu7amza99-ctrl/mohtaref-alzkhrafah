...
// ---- زخارف ديناميكية عامة تعتمد على "طظج" كنموذج ----
function specialDynamicVariants(name) {
  const nm = (name || '').trim();
  const arr = [];

// ===== قاعدة زخارف جاهزة (120 نمط — 4 مجموعات × 30) =====
  const base = [
    // --- GROUP 1: Stars / Symbols (30)
    ...
    // --- GROUP 2: Hearts / Emojis (30)
    '💖 {txt} 💖','💞 {txt} 💞','💝 {txt} 💝','💗 {txt} 💗','💓 {txt} 💓','💕 {txt} 💕',
    '💘 {txt} 💘','💟 {txt} 💟','💛 {txt} 💛','💚 {txt} 💚','💙 {txt} 💙','💜 {txt} 💜',
    '🧡 {txt} 🧡','🖤 {txt} 🖤','💞✨ {txt} ✨💞','🌸 {txt} 🌸','🌺 {txt} 🌺','🌷 {txt} 🌷',
    '🌼 {txt} 🌼','🌻 {txt} 🌻','🍀 {txt} 🍀','🌹 {txt} 🌹','🌟💫 {txt} 💫🌟','🌙 {txt} 🌙',
    '☀️ {txt} ☀️','⭐ {txt} ⭐','🎀 {txt} 🎀','🎉 {txt} 🎉','🎈 {txt} 🎈','✨ {txt} ✨',

    // --- GROUP 3: Frames / Boxes / Borders (30)
    '『 {txt} 』','【 {txt} 】','〖 {txt} 〗','《 {txt} 》','「 {txt} 」','『• {txt} •』',
    '【★ {txt} ★】','▂▃▄▅ {txt} ▅▄▃▂','┏★ {txt} ★┓','┏( ・o・)┛ {txt} ┗(・o・)┓','╔═ {txt} ═╗','╚═ {txt} ═╝',
    '╭✧ {txt} ✧╮','╰☆ {txt} ☆╯','┌♡ {txt} ♡┐','└❤ {txt} ❤┘','┎━ {txt} ━┒','╒═ {txt} ═╕',
    '▁▂▃ {txt} ▃▂▁','■ {txt} ■','◢◤ {txt} ◥◣','❲ {txt} ❳','☾ {txt} ☽','◦•● {txt} ●•◦',
    '▫️ {txt} ▫️','▣ {txt} ▣','✪ {txt} ✪','❂ {txt} ❂','◈ {txt} ◈','✵ {txt} ✵',

    // --- GROUP 4: Mixed / separators / long decorative (30)
    '•·• {txt} •·•','•°· {txt} ·°•','°•..•° {txt} °•..•°','*~* {txt} *~*',
    '~✿~ {txt} ~✿~','•]••[ {txt} ]••[•','°•✩• {txt} •✩•°','•↣ {txt} ↢•',
    '·͡ˑ· {txt} ·͡ˑ·','·*• {txt} •*·','⌘ {txt} ⌘','☆·. {txt} .·☆',
    '۞ {txt} ۞','•▬▬ {txt} ▬▬•','↫ {txt} ↬','☙ {txt} ☙','▪︎ {txt} ▪︎',
    '✽･{txt}･✽','✺·.· {txt} ·.·✺','╾━╤デ {txt} デ╤━╾','✦·. {txt} .·✦',
    '°•~ {txt} ~•°','» {txt} «','✿·° {txt} °·✿','⎨ {txt} ⎬',
    '༺ {txt} ༻','⋆° {txt} °⋆','⋆·. {txt} .·⋆','✵✵ {txt} ✵✵'
  ];
  ...
  // استبدل المتغير {txt} بالاسم المدخل
  base.forEach(p => {
    arr.push(p.replace('{txt}', nm));
  });
...
// ---- زخارف الاسماء الديناميكية ----
function specialDynamicVariants(name) {
  const nm = (name || '').trim();
  const arr = [];

  // المجموعات الأربع (كل مجموعة 30 نمط تقريباً)
  const baseSets = [
    // المجموعة 1 – زخارف خفيفة
    [
      '𓆩'+nm+'𓆪', '☆'+nm+'★', '✿'+nm+'✿', '♚'+nm+'♛', '♡'+nm+'♡', '♔'+nm+'♕', '꧁'+nm+'꧂', 
      '★'+nm+'☆', '✧'+nm+'✧', '°'+nm+'°', '•'+nm+'•', '♩'+nm+'♪', '✿ '+nm+' ✿', '☾'+nm+'☽', '❖'+nm+'❖'
    ],
    // المجموعة 2 – زخارف بتشكيل
    [
      'يَ'+nm+'ـسْمِيِّنَ', 'يٰ'+nm+'ـمِيْن', 'يِ'+nm+'ـسِمِيْن', 'يُ'+nm+'ـسُمِيْنَ', 
      '°يَ'+nm+'ـسْمِيِّن°', '♡يٰ'+nm+'ـسْمِيْن♡', '★يِ'+nm+'ـسِمِيْن★'
    ],
    // المجموعة 3 – زخارف مزخرفة برموز
    [
      '• '+nm+' •', '★ '+nm+' ★', '✿ '+nm+' ✿', '💞 '+nm+' 💞', '💫 '+nm+' 💫', 
      '🌸 '+nm+' 🌸', '✨ '+nm+' ✨', '❤️ '+nm+' ❤️', '💛 '+nm+' 💛', '🖤 '+nm+' 🖤'
    ],
    // المجموعة 4 – دمج الرموز والاحرف الزخرفية
    [
      '°•° '+nm+' °•°', '『 '+nm+' 』', '【 '+nm+' 】', '☾ '+nm+' ☽', '꧁ '+nm+' ꧂',
      '✾ '+nm+' ✾', '♧ '+nm+' ♧', '♤ '+nm+' ♤', '♢ '+nm+' ♢', '♧♢ '+nm+' ♤♤'
    ]
  ...
  // دمج كل المجموعات
  baseSets.forEach(set => arr.push(...set));
